...
function Hero() {
  ...
  return (
    <section className="relative my-10 lg:flex lg:flex-row-reverse xl:max-w-[1440px] xl:mx-auto">
      <div className="lg:w-1/2">
        <img src={heroImg} alt="hero-image" className="w-fit mx-auto" />
      ...
      <div className="text-center lg:text-left lg:w-1/2 xl:max-w-3xl">
        <div className="my-10">
